...
var findPdfNodeByPlaceholderId = function (doc, placeholderId) {
    var result = null;
...
var handlePdfUpload = function (_a) {
    ...
    return function (file, editor, pos, pageId) { return __awaiter(void 0, void 0, void 0, function () {
        var validated, placeholderId, placeholderInserted, insertPlaceholder, replacePlaceholderWithPdf, removePlaceholder, insertPlaceholderTimeout, attachment_1, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    insertPlaceholder = function () {
                        return function (_a) {
                            ...
                            var initialPlaceholderNode = (_b = state.schema.nodes.pdf) === null || _b === void 0 ? void 0 : _b.create({
                                placeholder: {
                                    id: placeholderId,
                                    name: file.name,
                                },
                    ...
                    replacePlaceholderWithPdf = function (attachment) {
                        return function (_a) {
                            var tr = _a.tr;
                            var _b = (findPdfNodeByPlaceholderId(tr.doc, placeholderId) || {}).pos, currentPos = _b === void 0 ? null : _b;
                ...
                case 2:
                    ...
                    if (placeholderInserted) {
                        setTimeout(function () {
                            editor.commands.command(replacePlaceholderWithPdf(attachment_1));
                        }, 100);
                    }
                    else {
                        editor
                            ...
                            .command(replacePlaceholderWithPdf(attachment_1))
                            .run();
                    }
                    return [3 /*break*/, 4];
                case 3:
