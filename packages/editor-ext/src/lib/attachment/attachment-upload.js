...
var findAttachmentNodeByPlaceholderId = function (doc, placeholderId) {
    var result = null;
...
var handleAttachmentUpload = function (_a) {
    var validateFn = _a.validateFn, onUpload = _a.onUpload;
    return function (file, editor, pos, pageId, allowMedia) { return __awaiter(void 0, void 0, void 0, function () {
        var validated, placeholderId, placeholderInserted, insertPlaceholder, replacePlaceholderWithAttachment, removePlaceholder, insertPlaceholderTimeout, attachment_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    validated = validateFn === null || validateFn === void 0 ? void 0 : validateFn(file, allowMedia);
                    // @ts-ignore
                    if (!validated)
                        return [2 /*return*/];
                    ...
                    insertPlaceholder = function () {
                        return function (_a) {
                            ...
                            var initialPlaceholderNode = (_b = state.schema.nodes.attachment) === null || _b === void 0 ? void 0 : _b.create({
                                placeholder: {
                                    id: placeholderId,
                                },
                                name: file.name,
                    ...
                    replacePlaceholderWithAttachment = function (attachment) {
                        return function (_a) {
                            var tr = _a.tr;
                            var _b = (findAttachmentNodeByPlaceholderId(tr.doc, placeholderId) || {}).pos, currentPos = _b === void 0 ? null : _b;
                            ...
                            tr.setNodeMarkup(currentPos, undefined, {
                                url: "/api/files/".concat(attachment.id, "/").concat(attachment.fileName),
                ...
                case 2:
                    attachment_1 = _a.sent();
                    clearTimeout(insertPlaceholderTimeout);
                    if (placeholderInserted) {
                        setTimeout(function () {
                            editor.commands.command(replacePlaceholderWithAttachment(attachment_1));
                        }, 100);
                    }
                    else {
                        editor
                            ...
                            .command(replacePlaceholderWithAttachment(attachment_1))
                            .run();
                    }
                    return [3 /*break*/, 4];
                case 3:
