...
var findAudioNodeByPlaceholderId = function (doc, placeholderId) {
    var result = null;
...
var handleAudioUpload = function (_a) {
    ...
    return function (file, editor, pos, pageId) { return __awaiter(void 0, void 0, void 0, function () {
        var validated, objectUrl, placeholderId, placeholderInserted, insertPlaceholder, replacePlaceholderWithAudio, removePlaceholder, insertPlaceholderTimeout, disposePreviewFile, attachment_1, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    insertPlaceholder = function () {
                        return function (_a) {
                            ...
                            var initialPlaceholderNode = (_b = state.schema.nodes.audio) === null || _b === void 0 ? void 0 : _b.create({
                                placeholder: {
                                    id: placeholderId,
                                    name: file.name,
                                },
                    ...
                    replacePlaceholderWithAudio = function (attachment) {
                        return function (_a) {
                            var tr = _a.tr;
                            var _b = (findAudioNodeByPlaceholderId(tr.doc, placeholderId) || {}).pos, currentPos = _b === void 0 ? null : _b;
                ...
                case 2:
                    ...
                    if (placeholderInserted) {
                        setTimeout(function () {
                            editor.commands.command(replacePlaceholderWithAudio(attachment_1));
                            disposePreviewFile();
                        }, 100);
                    }
                    else {
                        editor
                            ...
                            .command(replacePlaceholderWithAudio(attachment_1))
                            .run();
                        disposePreviewFile();
                    }
                    return [3 /*break*/, 4];
