...
exports.Excalidraw = core_1.Node.create({
    ...
    addCommands: function () {
        return {
            ...
            setExcalidrawAlign: function (align) {
                return function (_a) {
                    var commands = _a.commands;
                    return commands.updateAttributes("excalidraw", { align: align });
                };
            },
            setExcalidrawSize: function (width, height) {
                return function (_a) {
                    var commands = _a.commands;
                    return commands.updateAttributes("excalidraw", { width: width, height: height });
                };
            },
        };
    },
