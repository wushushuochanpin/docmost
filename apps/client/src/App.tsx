...
const PasswordReset = lazyWithRetry(
...
const Security = lazyWithRetry(
  () => import("@/ee/security/pages/security.tsx"),
);
...
const Shares = lazyWithRetry(
  () => import("@/pages/settings/shares/shares.tsx"),
);
...
const PdfRenderPage = lazyWithRetry(
  () => import("@/ee/pdf-export/pdf-render-page.tsx"),
);
const VerifiedPages = lazyWithRetry(
  () => import("@/ee/page-verification/pages/verified-pages.tsx"),
);
const TemplateList = lazyWithRetry(
  () => import("@/ee/template/pages/template-list"),
);
const TemplateEditor = lazyWithRetry(
  () => import("@/ee/template/pages/template-editor"),
);
const FavoritesPage = lazyWithRetry(
  () => import("@/pages/favorites/favorites-page"),
);
const AiChat = lazyWithRetry(() => import("@/ee/ai-chat/pages/ai-chat.tsx"));
const VerifyEmail = lazyWithRetry(() => import("@/ee/pages/verify-email.tsx"));
